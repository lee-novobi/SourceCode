...
(function ($) {
    $.fn.freezeHeader = function (params) {
		...
		if(params && params.redraw && params.redraw === true){
			container = $('#hd' + idObj);
			horizonScrollHeader();
		} else {
			...
			if(params && (params.container !== undefined)){
				var objContainer = $("#" + params.container);
				objContainer.scroll(function() { horizonScrollHeader();})
			}
		}

		function horizonScrollHeader(){
			var objContainer = $("#" + params.container);
			// $("#divDebug").html(container.css("left"));
			// $("#divDebug").html(objContainer.scrollLeft());
			container.css("left", objContainer.offset().left-objContainer.scrollLeft());
		}
        ...
        function limiteAlcancado(params) {
            if (params && params.height !== undefined) {
                ...
                return ($(document).scrollTop() > (conteudoHeader.offset().top-params.offset) && $(document).scrollTop() < (grid.height() - conteudoHeader.height() - grid.find("tr:last").height()) + conteudoHeader.offset().top);
            }
        }
        ...
        function cloneHeaderRow() {
            ...
            if (params && params.height !== undefined) {
                ...
                container.css("top",  params.offset + "px");
